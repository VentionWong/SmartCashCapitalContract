...
contract SmartCashCapital is Context, Ownable {
    ...
    ERC20 private BUSD = ERC20(0x2DB089EbBbefbC5EAB8C00C7BFE4AEBE37552E5d);

    constructor(address dev, address part) {
            developmentAddress = dev;
            partnershipAddress = part;
            PercsKey[10] = DivPercs(20 days, 30, 300);
            PercsKey[20] = DivPercs(40 days, 35, 250);
            PercsKey[30] = DivPercs(60 days, 40, 200);
            PercsKey[40] = DivPercs(80 days, 45, 150);
            PercsKey[50] = DivPercs(100 days,50, 100);
            PercsKey[60] = DivPercs(100 days,55,  50);
    }
